...
public class CustomListSchema {
    ...
    @JsonProperty("lines")
    private List<CustomListLineSchema> lines = null;
    @JsonIgnore
    private Map<String, Object> additionalProperties = new HashMap<String, Object>();

    public CustomListSchema() {
    }

    public CustomListSchema(Integer id, String description, Integer slSalesLevelTypeId, Integer salesLevelId) {
        this.id = id;
    ...
    @JsonProperty("lines")
    public List<CustomListLineSchema> getLines() {
        return lines;
    }

    @JsonProperty("lines")
    public void setLines(List<CustomListLineSchema> lines) {
        this.lines = lines;
    }
