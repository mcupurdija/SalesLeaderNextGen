...
public class CategoriesOfItemSchema {
    ...
    @JsonProperty("categoryOfItemsBusinessKey")
    private String categoryOfItemsBusinessKey;
    ...
    @JsonProperty("categoryOfItemsBusinessKey")
    public String getCategoryOfItemsBusinessKey() {
        return categoryOfItemsBusinessKey;
    }

    @JsonProperty("categoryOfItemsBusinessKey")
    public void setCategoryOfItemsBusinessKey(String categoryOfItemsBusinessKey) {
        this.categoryOfItemsBusinessKey = categoryOfItemsBusinessKey;
    }
